...
def Mark_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying Acc Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Acc Nuke Deployed. . .")
    ...
    setTitle(f"Acc Nuke Successfully Detonated!")
    print_slow(f"{Fore.LIGHTGREEN_EX}Succesfully turned {a} into a Markous Wasteland ")
